import "./styles.css";
import {controller, saveToStorage, loadFromStorage} from "./controller.js";
...
const control = new controller();
loadFromStorage(control);

if(control.projectCounter===0){
    const p = new project("Work", "Work related tasks");
    const c = new project("Personal", "Personal tasks");
...
console.log(control.projectCounter);
